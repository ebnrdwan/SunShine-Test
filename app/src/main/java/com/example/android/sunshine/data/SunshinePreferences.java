...
public final class SunshinePreferences {
    ...
    public static boolean isNotificationEnbled(Context context){
        String notification_key = context.getString(R.string.pref_notification_by_default_key);
        boolean notificationState= context.getResources().getBoolean(R.bool.show_notification_by_Default);
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        boolean notificationByDefault = preferences.getBoolean(notification_key,notificationState);
        return notificationByDefault;
    }
}